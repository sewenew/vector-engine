...
#ifndef SW_VECTOR_ENGINE_UNKNOWN_TASK_H
#define SW_VECTOR_ENGINE_UNKNOWN_TASK_H
...
class UnknownOutput : public TaskOutput {
public:
    explicit UnknownOutput(RespCommand cmd) : _cmd(std::move(cmd)) {}
...
#endif // end SW_VECTOR_ENGINE_UNKNOWN_TASK_H
